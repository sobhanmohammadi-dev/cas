...
{
    // toMathString() is provided by MathNode (delegates to __toString).
    // Concrete numeric subclasses override it for a clean representation.
    abstract public function isZero(): bool;
    abstract public function isOne(): bool;
    abstract public function toInteger(): ?IntegerNode;

    /**
     * Parse a decimal / scientific-notation string into the most reduced
     * exact numeric node (IntegerNode or RationalNode).
     */
    public static function fromDecimalString(string $raw, int $start, int $end): self
    {
        ...
        // Split off optional scientific-notation exponent
