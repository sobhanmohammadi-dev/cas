...
abstract class BinaryOperatorNode extends MathNode
{
    ...
    public function getLeft(): MathNode  { return $this->left; }
    public function getRight(): MathNode { return $this->right; }

    public function __toString(): string
    {
        return '(' . $this->left . ' ' . $this->getOperatorSymbol() . ' ' . $this->right . ')';
    }
}
